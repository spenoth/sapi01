...
public class RepositorySprintService implements SprintService {
    ...
    public Sprint add(SprintDTO added) {
        ...
        Sprint model = added.getBuilder()
        		.setTitle(added.getTitle())
                .description(added.getDescription())
                .setFromDt(added.getFromDt())
                .setToDt(added.getToDt())
                .build();
    ...
    public Sprint update(SprintDTO updated) throws NotFoundException {
        ...
        model.update(updated.getDescription(), updated.getTitle(), updated.getFromDt(), updated.getToDt());
